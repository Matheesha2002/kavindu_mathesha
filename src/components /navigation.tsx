...
function Navigation() {
    ...
    return (
        ...
        `}
        >
            <nav className="px-2 py-6 flex items-center  justify-between text-white">
            ...
            {/* Mobile Menu */}
            {isOpen && (
                <ul className="md:hidden bg-black/70 backdrop-blur-xl text-center py-6 space-y-4 rounded-b-xl">
